...
class _MyHomePageState extends State<MyHomePage> {
  final asset = 'assets/motherboard_am4.glb';
  ...
  Future<void> _onPlaneOrPointTapped(
    ...
    final singleHitTestResult = hitTestResults.firstWhere((result) => result.type == ARHitTestResultType.plane);
    ...
    if (didAddAnchor == true) {
      ...
      final didAddNodeToAnchor = await arObjectManager.addNode(newNode, planeAnchor: newAnchor);
